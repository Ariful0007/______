...
public class TreeAdapter1 extends RecyclerView.Adapter<TreeAdapter1.myview> {
    public List<Refdferal_model> data;
    FirebaseFirestore firebaseFirestore;
    FirebaseAuth firebaseAuth;
    Context context;

    public TreeAdapter1(List<Refdferal_model> data, Context context) {
    ...
    @NonNull
    @Override
    public TreeAdapter1.myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.tree_layout, parent, false);
        return new TreeAdapter1.myview(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TreeAdapter1.myview holder, final int position) {
