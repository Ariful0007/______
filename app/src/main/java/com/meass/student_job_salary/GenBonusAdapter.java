...
public class GenBonusAdapter extends RecyclerView.Adapter<GenBonusAdapter.myview> {
    public List<Income> data;
    FirebaseFirestore firebaseFirestore;

    public GenBonusAdapter(List<Income> data) {
        this.data = data;
    }

    @NonNull
    @Override
    public GenBonusAdapter.myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.income, parent, false);
        return new GenBonusAdapter.myview(view);
    }

    @Override
    public void onBindViewHolder(@NonNull GenBonusAdapter.myview holder, final int position) {
        holder.customer_name.setText("Level Income");
