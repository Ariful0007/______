...
public class LeaderAdapter extends RecyclerView.Adapter<LeaderAdapter.myview> {
    public List<Income> data;
    FirebaseFirestore firebaseFirestore;

    public LeaderAdapter(List<Income> data) {
        this.data = data;
    }

    @NonNull
    @Override
    public LeaderAdapter.myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.income, parent, false);
        return new LeaderAdapter.myview(view);
    }

    @Override
    public void onBindViewHolder(@NonNull LeaderAdapter.myview holder, final int position) {
        holder.customer_name.setText("Leadership Income");
