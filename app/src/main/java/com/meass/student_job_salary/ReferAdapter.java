...
public class ReferAdapter extends RecyclerView.Adapter<ReferAdapter.myview> {
    public List<Income> data;
    FirebaseFirestore firebaseFirestore;

    public ReferAdapter(List<Income> data) {
        this.data = data;
    }

    @NonNull
    @Override
    public ReferAdapter.myview onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.income, parent, false);
        return new ReferAdapter.myview(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ReferAdapter.myview holder, final int position) {
        holder.customer_name.setText("Refer Income");
