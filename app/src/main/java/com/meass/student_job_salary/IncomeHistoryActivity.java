...
public class IncomeHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setTitle("Daily Bonus  History");
        ...
        getDataAdapter1 = new IncomeAdapter(getList);
        firebaseFirestore = FirebaseFirestore.getInstance();
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(IncomeHistoryActivity.this));
